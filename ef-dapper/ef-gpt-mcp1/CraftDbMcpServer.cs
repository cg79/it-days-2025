...
[McpServerToolType, Description("""
                                    CraftDbMcpServer is a specialized MCP Server Tool interface for exploring and modifying the 'BookCraftDB' SQLite database.
                                    ...
                                    All operations are tailored exclusively for MySql syntax and features, as BookCraftDB is implemented using SQLite. 
                                ...
                                """)]
public static class CraftDbMcpServer
{
    ...
    private static MySqlSchemaService CreateSqliteSchemaService() => new(GetConnectionString());
